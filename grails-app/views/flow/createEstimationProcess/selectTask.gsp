...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function next() {
                ...
                $('#task').after('<input type="hidden" name="_eventId_continue" value="_eventId_continue" id="_eventId_continue" style="display:none"/>');
                $('form')[1].submit();
            }

            function cancel() {
            	$('#task').after('<input type="hidden " name="_eventId_cancel" value="_eventId_cancel" id="_eventId_cancel" style="display:none"/>');
                $('form')[1].submit();
            }
        </script>
    </head>
    <body>		
		<div id="step-holder">
			...
			<div class="step-light-left"><g:message code="requirement.select.label" default="Select requirement"/></div>
			<div class="step-light-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-dark-left"><g:message code="task.select.label" default="Select task"/></div>
			<div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">3</div>
			<div class="step-light-left"><g:message code="estimation.details.label" default="Enter estimation details"/></div>
				...
				<div id="content-table-inner">
					...
					<div id="table-content">
						...
						<tr>
                            ...
                            <g:sortableColumn class="table-header-repeat line-left" property="id" title="${message(code: 'task.id.label', default: 'Id')}" />
                            <g:sortableColumn class="table-header-repeat line-left" property="description" title="${message(code: 'task.description.label', default: 'Description')}" />
                            <g:sortableColumn class="table-header-repeat line-left" property="type" title="${message(code: 'task.type.label', default: 'Type')}" />
						</tr>
	                    <g:each in="${taskInstanceList}" status="i" var="taskInstance">
	                        <tr class="${(i % 2) == 0 ? '' : 'alternate-row'}">
	                        	<td><input  type="checkbox" value="${taskInstance?.id}"/></td>
					...
					<g:form action="createEstimationProcess">
						<g:hiddenField name="task" id="task"></g:hiddenField>
						<div id="actions-box">
