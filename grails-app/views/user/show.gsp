	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.firstSurname}">
				<li class="fieldcontain">
					<span id="firstSurname-label" class="property-label"><g:message code="user.firstSurname.label" default="First Surname" /></span>
					
						<span class="property-value" aria-labelledby="firstSurname-label"><g:fieldValue bean="${userInstance}" field="firstSurname"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${userInstance?.secondSurname}">
				<li class="fieldcontain">
					<span id="secondSurname-label" class="property-label"><g:message code="user.secondSurname.label" default="Second Surname" /></span>
					
						<span class="property-value" aria-labelledby="secondSurname-label"><g:fieldValue bean="${userInstance}" field="secondSurname"/></span>
				...
				<g:if test="${userInstance?.estimations}">
				<li class="fieldcontain">
					<span id="estimations-label" class="property-label"><g:message code="user.estimations.label" default="Estimations" /></span>
